...
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		map.put("module/bedmanagement/wards.list", "Manage ward");
		map.put("module/bedmanagement/beds.list", "Manage bed");
		map.put("module/bedmanagement/bedOccupancy.list","Manage Admission");
		map.put("module/bedmanagement/bedOccupancy.form", "Bed Report");
